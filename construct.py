...
PASSAGE_GRAPH_BATCH = [tf.placeholder(dtype=tf.int32, shape=[None, None]) for _ in range(batch_size)]
...
PASSAGE_GRAPH = tf.placeholder(dtype=tf.int32, shape=[None, None])
...
QUESTION_GRAPH = tf.placeholder(dtype=tf.int32, shape=[None, None])
...
for index in range(batch_size):
    ...
    tf.add_to_collection(name="PASSAGE_GRAPH_BATCH", value=PASSAGE_GRAPH_BATCH[index])
...
tf.add_to_collection(name="PASSAGE_GRAPH", value=PASSAGE_GRAPH)
...
tf.add_to_collection(name="QUESTION_GRAPH", value=QUESTION_GRAPH)
